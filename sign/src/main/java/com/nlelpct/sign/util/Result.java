...
public class Result implements Serializable {
    ...
    public static Result error(CodeMsg fillArgs) {
        return Result.build(fillArgs.getCode(), fillArgs.getMsg());
    }

    public static Result error(CodeMsg serverError, String message) {
        return Result.build(serverError.getCode(), serverError.getMsg(), message);
    }
}
